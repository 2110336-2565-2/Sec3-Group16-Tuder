...
const (
	// Label holds the string label denoting the classcancelrequest type in the database.
	Label = "class_cancel_request"
	...
	EdgeUser = "user"
	// Table holds the table name of the classcancelrequest in the database.
	Table = "class_cancel_requests"
	// MatchTable is the table that holds the match relation/edge.
	MatchTable = "class_cancel_requests"
	...
	MatchColumn = "match_class_cancel_request"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "class_cancel_requests"
	// UserInverseTable is the table name for the User entity.
	// It exists in this package in order to avoid circular dependency with the "user" package.
	UserInverseTable = "users"
	// UserColumn is the table column denoting the user relation/edge.
	UserColumn = "user_class_cancel_request"
)

// Columns holds all SQL columns for classcancelrequest fields.
var Columns = []string{
	FieldID,
	FieldTitle,
	FieldReportDate,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "class_cancel_requests"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"match_class_cancel_request",
	"user_class_cancel_request",
}
...
func StatusValidator(s Status) error {
	...
	case StatusPending, StatusApproved, StatusRejected:
		return nil
	default:
		return fmt.Errorf("classcancelrequest: invalid enum value for status field: %q", s)
	}
}
