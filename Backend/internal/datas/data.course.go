...
func InsertCourse(client *ent.Client, ctx context.Context, tutor []*ent.Tutor) []*ent.Course {
	...
	course5 := CreateCourse(client, tutor[0], "Introduction to Python programming", "Programming", "Python", 320, "Learn the basics of Python programming language", 450, Course.LevelGrade9, "https://i.ytimg.com/vi/uYjRzbP5aZs/maxresdefault.jpg")
	course6 := CreateCourse(client, tutor[1], "Introduction to Java programming", "Programming", "Java", 20, "Learn the basics of Java programming language", 450, Course.LevelGrade10, "https://artoftesting.com/wp-content/uploads/2020/03/introduction-to-java-featured.jpg")
	course7 := CreateCourse(client, tutor[0], "Introduction to C programming", "Programming", "C", 30, "Learn the basics of C programming language", 550, Course.LevelGrade7, "https://i.ytimg.com/vi/gEJBFKDkqTE/maxresdefault.jpg")
